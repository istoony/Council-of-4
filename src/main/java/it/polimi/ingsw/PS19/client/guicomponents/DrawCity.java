...
public class DrawCity extends JPanel{
	
	private static final String YELLOW = "FFFF00";
	private static final String YELLOW_PATH = "images/yellowucity.png";
    ...
    protected DrawCity(City c) {
    	if(c.getCitycolor()==Color.decode(YELLOW)){
    		try {                
    	...
    	else if(c.getCitycolor()==Color.decode(RED)){
    		try {                
    	...
    	else if(c.getCitycolor()==Color.decode(BLUE)){
    		try {                
    	...
    	else if(c.getCitycolor()==Color.decode(GREY)){
    		try {                
    	...
    	else if(c.getCitycolor()==Color.decode(VIOLET)){
    		try {                
